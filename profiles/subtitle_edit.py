...
class SubtitleEdit_Manager(Base_Profile):

    program_name = 'SubtitleEdit'

    default_path = 'C:\\Portable\\subtitleedit\\'
    ...
    def _get_latest_version(self):
        ...
        Returns:
            str : Latest version
        """
        return self._http_head_req('https://github.com/SubtitleEdit/subtitleedit/releases/latest').headers['Location'].split('/')[-1]
    ...
    def _update_program(self):
        ...
        Advices:
            - The logger interface is in 'self._logger'
            - You can find the actual operation ('install' or 'update') into 'self._mode' attribute
            - Use 'self._latest_version' attribute
            - Use 'self._path' attribute
            - Use 'self._dl_data_list' attribute
