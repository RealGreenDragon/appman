...
class Gifsicle_Manager(Base_Profile):

    program_name = 'Gifsicle'

    default_path = 'C:\\Portable\\gifsicle\\'
    ...
    def _get_latest_version(self):
        ...
        return self._http_get_req('https://eternallybored.org/misc/gifsicle/').split(' - Gifsicle ')[1].split(' ')[0].strip()
    ...
    def _get_download_data(self):
        ...
        self.fname = 'gifsicle-{}-win{}'.format(self._latest_version, self._arch)
        return dl_get(
                os.path.join(self._tmp_dir, 'gifsicle_latest.zip'),
                'https://eternallybored.org/misc/gifsicle/releases/{}.zip'.format(self.fname)
            )
    ...
    def _update_program(self):
        ...
        extracted_folder = os.path.join(self._path, self.fname)
