...
class MediaInfo_Manager(Base_Profile):

    program_name = 'MediaInfo'

    default_path = 'C:\\Portable\\mediainfo\\'
    ...
    def _get_latest_version(self):
        ...
        return self._http_get_req('https://mediaarea.net/MediaInfo/ChangeLog').split('Version ')[1].split(',')[0]
    ...
    def _get_download_data(self):
        ...
        url = 'https://mediaarea.net/download/binary/mediainfo-gui/{ver}/MediaInfo_GUI_{ver}_Windows_{arc}_WithoutInstaller.7z' \
        .format(ver=self._latest_version, arc='i386' if self._arch == '32' else 'x64')
        return dl_get(
