...
class Rufus_Manager(Base_Profile):

    program_name = 'rufus'

    default_path = 'C:\\Portable\\rufus\\'
    ...
    def __init__(self, **prog_data):
        ...
        self.std_exe = os.path.join(self._path, 'rufus.exe')
    ...
    def _get_latest_version(self):
        ...
        return self._http_get_req('https://rufus.akeo.ie/').split('/downloads/rufus-')[1].split('.exe')[0].strip()
    ...
    def _get_download_data(self):
        ...
        return dl_get(self.std_exe, 'https://rufus.akeo.ie/downloads/rufus-{}p.exe'.format(self._latest_version))
