...
class Pandoc_Manager(Base_Profile):

    program_name = 'pandoc'

    default_path = 'C:\\Portable\\pandoc\\'
    ...
    def _get_latest_version(self):
        ...
        Returns:
            str : Latest version
        """
        with self._http_head_req('https://github.com/jgm/pandoc/releases/latest') as r:
    ...
    def _update_program(self):
        ...
        extracted_folder = os.path.join(
            self._path,
            'pandoc-{}'.format(self._latest_version)
            )
