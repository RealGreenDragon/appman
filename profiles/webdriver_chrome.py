...
class WebdriverChrome_Manager(Base_Profile):

    program_name = 'Webdriver-Chrome'

    default_path = 'C:\\Portable\\webdrivers\\chrome\\'
    ...
    def _get_latest_version(self):
        ...
        return self._http_get_req('https://chromedriver.storage.googleapis.com/LATEST_RELEASE').strip()
    ...
    def _get_download_data(self):
        ...
        return dl_get(
                os.path.join(self._tmp_dir, 'webdriver_chrome_latest.zip'),
                'https://chromedriver.storage.googleapis.com/{}/chromedriver_win32.zip'.format(self._latest_version)
            )
